...
| --- | --- | --- |
| shared `core/skills/<name>/` | `~/.agents/skills/<name>/` | Directory symlink |
...
Run `python3 installers/codex/install.py --skip-integrations` to synchronize only filesystem artifacts.
