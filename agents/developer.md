...
- Declare done only with end-to-end evidence from the real runtime, in a draft pull request opened through code-host whose title and description explain the change and carry a conformance matrix that lists nothing beyond the plan.
...
- The conformance matrix is a self-check; do not issue a review verdict on your own change or mark your pull request ready for review.
- Never ask knowledge-base to persist a plan revision, progress, conformance, or results; the discoverer alone writes the plan.
