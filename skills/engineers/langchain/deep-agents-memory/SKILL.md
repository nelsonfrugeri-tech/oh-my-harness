...
description: |
  Memória, persistência e filesystem em Deep Agents. Cobre StateBackend (efêmero), StoreBackend
  (persistente), FilesystemMiddleware e CompositeBackend para routing entre backends. Corpo em
  inglês, vendorizado de langchain-ai/langchain-skills (fiel ao upstream).
  Use quando: (1) Dar memória/persistência a um Deep Agent, (2) Escolher entre StateBackend e
  StoreBackend, (3) Dar acesso a filesystem, (4) Rotear entre backends com CompositeBackend.
  Triggers: /deep-agents, deep agents memory, StoreBackend, StateBackend, FilesystemMiddleware.
type: knowledge
---
