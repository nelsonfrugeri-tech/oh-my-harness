...
description: |
  Fundamentos de agents em LangChain. Cobre create_agent, definição de tools com o decorator @tool,
  structured output e o básico de middleware (human-in-the-loop e error handling). Corpo em inglês,
  vendorizado de langchain-ai/langchain-skills (fiel ao upstream).
  Use quando: (1) Construir um agent com create_agent, (2) Definir tools, (3) Aplicar structured
  output ou middleware básico em LangChain.
  Triggers: /langchain, create_agent, langchain tools, langchain agent, @tool.
type: knowledge
---
