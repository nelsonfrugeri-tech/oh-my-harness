...
description: |
  Arquitetura base de aplicações Deep Agents. Cobre create_deep_agent(), a arquitetura do harness,
  o formato de SKILL.md e as opções de configuração. Corpo em inglês, vendorizado de
  langchain-ai/langchain-skills (fiel ao upstream).
  Use quando: (1) Construir uma aplicação Deep Agents, (2) Configurar o harness com
  create_deep_agent(), (3) Entender o formato/estrutura de skills de um Deep Agent.
  Triggers: /deep-agents, deep agents, create_deep_agent, deep agent harness.
type: knowledge
---
