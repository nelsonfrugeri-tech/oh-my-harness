...
description: |
  Fundamentos de LangGraph para escrever qualquer grafo. Cobre StateGraph, state schemas, nodes,
  edges, state reducers, Command, Send, invoke, streaming e error handling. Corpo em inglês,
  vendorizado de langchain-ai/langchain-skills (fiel ao upstream).
  Use quando: (1) Escrever código LangGraph, (2) Modelar StateGraph/state/edges, (3) Usar Command,
  Send, streaming ou tratar erros em um grafo.
  Triggers: /langgraph, langgraph, StateGraph, state graph, nodes edges, Command Send.
type: knowledge
---
