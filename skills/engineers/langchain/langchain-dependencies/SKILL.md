...
# Vendored de langchain-ai/langchain-skills — corpo fiel ao upstream, não traduzir.
upstream_version: langchain-ai/langchain-skills@2026-08-03
description: |
  Referência de gerenciamento de pacotes e versões do ecossistema LangChain (Python + TypeScript).
  Cobre pacotes obrigatórios, versões mínimas, requisitos de environment, boas práticas de
  versionamento e pacotes de tools da comunidade para LangChain, LangGraph, LangSmith e Deep Agents.
  Corpo em inglês, vendorizado de langchain-ai/langchain-skills (fiel ao upstream).
  Use quando: (1) Configurar um projeto LangChain novo, (2) Resolver conflitos de versão/instalação,
  (3) Descobrir o pacote/versão mínima correta de um componente do ecossistema.
  Triggers: /langchain, langchain install, langgraph pip, dependências langchain, versão langchain.
type: knowledge
---
