...
class DidacticVisualCorpusTest(unittest.TestCase):
    ...
    def test_protocol_requires_isolated_behavioral_evaluation(self) -> None:
        protocol = _ROOT.joinpath("core/evals/didactic-visual/README.md").read_text(
            encoding="utf-8"
        )
    ...
    def _cases(self) -> list[dict[str, object]]:
        path = _ROOT / "core/evals/didactic-visual/cases.json"
